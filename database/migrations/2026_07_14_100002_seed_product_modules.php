...
{
    /**
     * Module codes registered by this migration. `catalog` is a grouping module
     * that only backs the parent navigation node.
     *
     * @var list<string>
     */
    private array $moduleCodes = ['catalog', 'products', 'product_categories'];

    /**
     * Register the Catalog modules + navigation and grant every role full access.
    ...
    private function seedNavigations(array $modules): void
    {
        ...
        $children = [
            ...
            ['Categories', 'product_categories', '/product-categories', 'folder-tree'],
        ];
    ...
    /**
     * Grant every role access to all three modules with the full set of permissions.
     *
     * @param  array<string, Module>  $modules
     */
